...
/////////////////////////////// ////////////////////////////////////////////
  ...
  Route::group(['middleware'=>'permissions:categories'],function(){
    ...
    Route::get('/attribute/{childchildcatid}/attrCreateForChildchildcategory', 'Admin\AttributeController@attrCreateForChildchildcategory')->name('admin-attr-createForChildchildcategory');
  ...
  Route::delete('/subchildcategory/delete/{id}', 'Admin\SubChildCategoryController@destroy')->name('admin-subchildcat-delete');
  ...
  // CHILDCHILDCATEGORY SECTION ------------

  Route::get('/childchildcategory/datatables', 'Admin\ChildChildCategoryController@datatables')->name('admin-childchildcat-datatables'); //JSON REQUEST
  Route::get('/childchildcategory', 'Admin\ChildChildCategoryController@index')->name('admin-childchildcat-index');
  Route::get('/childchildcategory/create', 'Admin\ChildChildCategoryController@create')->name('admin-childchildcat-create');
  Route::post('/childchildcategory/create', 'Admin\ChildChildCategoryController@store')->name('admin-childchildcat-store');
  Route::get('/childchildcategory/edit/{id}', 'Admin\ChildChildCategoryController@edit')->name('admin-childchildcat-edit');
  Route::post('/childchildcategory/edit/{id}', 'Admin\ChildChildCategoryController@update')->name('admin-childchildcat-update');
  Route::delete('/childchildcategory/delete/{id}', 'Admin\ChildChildCategoryController@destroy')->name('admin-childchildcat-delete');
  Route::get('/childchildcategory/status/{id1}/{id2}', 'Admin\ChildChildCategoryController@status')->name('admin-childchildcat-status');
  Route::get('/load/childchildcategories/{id}/', 'Admin\ChildChildCategoryController@load')->name('admin-childchildcat-load'); //JSON REQUEST
...
Route::post('/item/report', 'Front\CatalogController@report')->name('product.report');
    ...
    Route::get('/category/{category?}/{subcategory?}/{childcategory?}/{subchildcategory?}/{childchildcategory?}','Front\CatalogController@category')->name('front.category');
