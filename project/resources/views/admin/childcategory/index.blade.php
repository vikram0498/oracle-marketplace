...
@section('content')
					<input type="hidden" id="headerdata" value="{{ __('CHILD 1 CATEGORY') }}">
					<input type="hidden" id="attribute_data" value="{{ __('ADD NEW ATTRIBUTE') }}">
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __('Child 1 Categories') }}</h4>
										<ul class="links">
											<li>
											...
											<li>
												<a href="{{ route('admin-childcat-index') }}">{{ __('Child 1 Categories') }}</a>
											</li>
										</ul>
								</div>
							</div>
