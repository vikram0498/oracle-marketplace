...
@section('content')
					<input type="hidden" id="headerdata" value="{{ __('CHILD 2 CATEGORY') }}">
<input type="hidden" id="attribute_data" value="{{ __('ADD NEW ATTRIBUTE') }}">
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ __('Child 2 Categories') }}</h4>
										<ul class="links">
											<li>
											...
											<li>
												<a href="{{ route('admin-subchildcat-index') }}">{{ __('Child 2 Categories') }}</a>
											</li>
										</ul>
								</div>
							</div>
