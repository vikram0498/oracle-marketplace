    ...
    <li>
            ...
            @endif" id="menu5" data-parent="#accordion" >
                    ...
                    <li class="@if(request()->is('admin/attribute/*/manage') && request()->input('type')=='childcategory') active @endif">
                        <a href="{{ route('admin-childcat-index') }}"><span>{{ __('Child 1 Category') }}</span></a>
                    </li>
                    <li class="@if(request()->is('admin/attribute/*/manage') && request()->input('type')=='subchildcategory') active @endif">
                        <a href="{{ route('admin-subchildcat-index') }}"><span>{{ __('Child 2 Category') }}</span></a>
                    </li>
                    <li class="@if(request()->is('admin/attribute/*/manage') && request()->input('type')=='childchildcategory') active @endif">
                        <a href="{{ route('admin-childchildcat-index') }}"><span>{{ __('Child 3 Category') }}</span></a>
                    </li>
            </ul>
    </li>
