...
//**************************** CUSTOM JS SECTION ****************************************
    ...
    $("#verificationprocess").on('submit', function (e) {
        ...
        success: function (data) {
          ...
          if ((data.errors)) {
            ...
            for (var error in data.errors) {
              ...
              $this.find('.alert-danger ul').html('<li>'+data.errors[error]+'</li>');
    ...
    $("#verificationprocessemail").on('submit', function (e) {
...
$("#notifyme").on('submit',function(e){
  ...
  $notifyme.find('button.submit-btn').prop('disabled',true);
...

       {
          ...
          if ((data.errors)) {
...

            {
              ...
              $notifyme.find('.alert-danger').show();

              $notifyme.find('.alert-danger p').html(data.errors[error]);
          ...
          toastr.success('Notify Me Added Successfully.');
          ...
          $notifyme.find('button.submit-btn').prop('disabled',false);
...
// Quick View Section
    ...
    $('.auction-detail-left-outer .all-slider').owlCarousel({
...
///
$('.trending-item-slider_category').owlCarousel({
    loop:true,
    margin:10,
...
$('.item-slider-childcategories').owlCarousel({
  loop:true,
  margin:10,
  responsiveClass:true,
  nav:true,
...
$(document).ready(function(){
  $(".backmenu").click(function(){
    $(".categories_mega_menu").renoveClass("open");
  });
});
...
// MOST VIEWED & TOP RATED, PREMIUM PRODUCTS slider
